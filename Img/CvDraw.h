...
inline void AddLayerRectangleDefaultColorCvImgQuick(IplImage* pImg, int i0, int j0, int i1, int j1, UCHAR red, UCHAR green, UCHAR blue)
{
	int i, j, index;
	unsigned char* img = (unsigned char*)pImg->imageData;
